...
yt-dlp %YTDLP_OPTIONS% --concurrent-fragments 110 -o "%OUTPUT_FOLDER%\Advanced Class - 01 Probability ## CGL Mains 2023 240.mp4" ""
yt-dlp %YTDLP_OPTIONS% --concurrent-fragments 107 -o "%OUTPUT_FOLDER%\Advanced Class - 01 Probability ## CGL Mains 2023 360.mp4" ""
yt-dlp %YTDLP_OPTIONS% --concurrent-fragments 103 -o "%OUTPUT_FOLDER%\Advanced Class - 01 Probability ## CGL Mains 2023 480.mp4" ""
yt-dlp %YTDLP_OPTIONS% --concurrent-fragments 100 -o "%OUTPUT_FOLDER%\Advanced Class - 01 Probability ## CGL Mains 2023 720.mp4" ""
yt-dlp %YTDLP_OPTIONS% --concurrent-fragments 110 -o "%OUTPUT_FOLDER%\Advanced Class - 02 Probability ## CGL Mains 2023 240.mp4" ""
yt-dlp %YTDLP_OPTIONS% --concurrent-fragments 107 -o "%OUTPUT_FOLDER%\Advanced Class - 02 Probability ## CGL Mains 2023 360.mp4" ""
yt-dlp %YTDLP_OPTIONS% --concurrent-fragments 103 -o "%OUTPUT_FOLDER%\Advanced Class - 02 Probability ## CGL Mains 2023 480.mp4" ""
yt-dlp %YTDLP_OPTIONS% --concurrent-fragments 100 -o "%OUTPUT_FOLDER%\Advanced Class - 02 Probability ## CGL Mains 2023 720.mp4" ""
yt-dlp %YTDLP_OPTIONS% --concurrent-fragments 110 -o "%OUTPUT_FOLDER%\Advanced Class - 03 Probability ## CGL Mains 2023 240.mp4" ""
yt-dlp %YTDLP_OPTIONS% --concurrent-fragments 107 -o "%OUTPUT_FOLDER%\Advanced Class - 03 Probability ## CGL Mains 2023 360.mp4" ""
yt-dlp %YTDLP_OPTIONS% --concurrent-fragments 103 -o "%OUTPUT_FOLDER%\Advanced Class - 03 Probability ## CGL Mains 2023 480.mp4" ""
yt-dlp %YTDLP_OPTIONS% --concurrent-fragments 100 -o "%OUTPUT_FOLDER%\Advanced Class - 03 Probability ## CGL Mains 2023 720.mp4" ""
